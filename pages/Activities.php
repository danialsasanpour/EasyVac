 ...
 <body style="background-image: url(../img/wall3.jpg);  background-repeat: repeat; background-size: 110%">
			...
			<div>
				...
				<div class="halfleft2">
					...
					<p style="color:#009999;font-size:20px;margin:30px">
						Includes transport and enter to MontrÃ©al Museum of Fine Arts,   Early to modern international art and the Biodome. Montreal is known for its vibrant arts scene, so these internationally renowned museums at the top of their game are a true feast for the eyes. For a fact, the museumâ€™s a stunning permanent collection of classic and modern visual art is free for everyone under 30, but their temporary exhibitions are also a spectacle to behold. Open this summer, Riopelle: The Call of Northern Landscapes and Indigenous Cultures celebrates the life and work of Quebecois modern artist Jean Paul Riopelle (1923-2002). Featuring never before seen pieces, major works, and restored works, this important collection of intercultural Canadian art is a must-see.
					</p>
				...
				<div class="halfleft2">
					...
					<p style="color:#009999;font-size:20px;margin:30px">
						Discover a complete relaxation experience at StrÃ¸m Nordic Spa, a peaceful haven located right near downtown Montreal. Enjoy a thermal experience at an exceptional Nordic spa that includes the rental of a bathrobe, a towel, and a locker. Summer or winter, rain or shine, reduce stress as you revive your body and mind.  Begin by relaxing your muscles in the whirlpool hot tubs. Eliminate toxins by going to a heated sauna, followed by a dip in an ice-cold bath and a period of deep relaxation.  Practiced for thousands of years, thermotherapy is a wellness ritual based on the external use of water for therapeutic purposes. Benefit from access to the outdoor whirlpools, thermal and Nordic baths, Finnish saunas, eucalyptus steam bath, thermal and Nordic waterfalls, plus indoor and outdoor relaxation areas with fireplaces.
					</p>
					<h2 style="color:#009999;text-align:right;margin-right:20px">DURATION:4 hr</h2>
				</div>
			...
			<div>
				...
				<div class="halfleft2">
					...
					<p style="color:#009999;font-size:20px;margin:30px">
						Enjoy a half-day rafting trip that features small splashy rapids, outstanding scenery and lots of laughs. Itâ€™s an ideal outdoor activity for families, children, seniors, and anyone looking for a gentle and fun scenic rafting adventure. As you raft down the glacier-fed Cheakamus River between old growth forests, youâ€™ll experience the excitement of gentle rapids and see a variety of birds, wildlife, waterfalls, and the towering peaks of the Coast Mountains. Learn about the intriguing Squamish First Nations history, a key part of the history of the area. There will also be a water fight for the kids. Perfect the art of splashing others and get a chance to cool off with a quick dip in the pure, glacier-fed water. When your river journey ends, you will be taken back to the fully equipped rafting base where you can change back into your own clothes and enjoy the facilities at the resort including a full service restaurant and awesome fully-licensed outdoor patio area. Relax with your family and friends in the beautiful sunshine and comfort of the resort, and check out the photos and videos shot on your trip.
					</p>
					<h2 style="color:#009999;text-align:right;margin-right:20px">DURATION:4 hr</h2>
				</div>
				<br><br><br><br><br><br>
		...
		<section id="boxes">
			<div>
				<div class="box">
					...
					<h2 class="footlinks" >2000, Sainte-Catherine Street West</br>MontrÃ©al, QuÃ©bec H3H 2T1</h2>
